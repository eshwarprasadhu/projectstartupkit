...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> productNotPurchased(ProductNotPurchased ex) {
    	ApiResponse apiResponse=new ApiResponse (HttpStatus.NOT_FOUND,5002,ex.getMessage());
    ...
    public  ResponseEntity<ApiResponse> unauthorisedAccess(UnauthorisedAccess ex) {
    	ApiResponse apiResponse=new ApiResponse (HttpStatus.NETWORK_AUTHENTICATION_REQUIRED,5003,ex.getMessage());
